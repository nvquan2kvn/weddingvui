<template>
    <div class="flex flex-col items-center justify-center p-4">
        <div class="flex justify-center">
            <img class="w-[150px] transition-transform duration-300 hover:scale-110"
                src="~/assets/images/ladi-img/2.png" alt="">
        </div>
        <h1 class="md:text-5xl text-4xl font-bold my-5 text-center font-dancing transition-transform duration-300 hover:scale-110">
            Chú Rể & Cô Dâu
        </h1>
...
<!--                            </svg>-->
<!--                        </a>-->
<!--                        <a class="animate-abc" href="https://zalo.me/0988266640" target="_blank">-->
...
<!--                        </a>-->
<!--                        <a class="animate-abc" href="tel:0988266640" target="_blank">-->
